// 国内DNS服务器
const domesticNameservers = ['https://dns.alidns.com/dns-query', // 阿里云公共DNS
  'https://doh.pub/dns-query', // 腾讯DNSPod
  'https://doh.360.cn/dns-query', // 360安全DNS
];

// 国外DNS服务器
const foreignNameservers = ['https://1.1.1.1/dns-query', // Cloudflare(主)
...
const dnsConfig = {
  ...
  'fake-ip-filter': [// 本地主机/设备
    '+.lan', '+.local', // Windows网络出现小地球图标
    '+.msftconnecttest.com', '+.msftncsi.com', // QQ快速登录检测失败
    'localhost.ptlogin2.qq.com', 'localhost.sec.qq.com', // 微信快速登录检测失败
...
const rules = [// 自定义规则
  ...
  // blackmatrix7 规则集
  'RULE-SET,openai,ChatGPT', // Loyalsoldier 规则集
  'RULE-SET,applications,全局直连', 'RULE-SET,private,全局直连', 'RULE-SET,reject,广告过滤', 'RULE-SET,icloud,微软服务', 'RULE-SET,apple,苹果服务', 'RULE-SET,google,谷歌服务', 'RULE-SET,proxy,节点选择', 'RULE-SET,gfw,节点选择', 'RULE-SET,tld-not-cn,节点选择', 'RULE-SET,direct,全局直连', 'RULE-SET,lancidr,全局直连,no-resolve', 'RULE-SET,cncidr,全局直连,no-resolve', 'RULE-SET,telegramcidr,电报消息,no-resolve', // 其他规则
